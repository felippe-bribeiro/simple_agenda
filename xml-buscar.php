    ...
    <hr />
    <form class="form-inline" action="main.php" name="frmBuscar" method="get">
	...
	if ($conta_result > 0){
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th><a href="main.php?opc=<?=$opc?>&buscar=<?=$buscar?>&id=<?=$id?>&action=buscar&order=@id&by=<?=$byC?>">Id</a></th>
                    <th><a href="main.php?opc=<?=$opc?>&buscar=<?=$buscar?>&id=<?=$id?>&action=buscar&order=@nome&by=<?=$byC?>">Nome</a></th>
					<th><a href="main.php?opc=<?=$opc?>&buscar=<?=$buscar?>&id=<?=$id?>&action=buscar&order=@nome&by=<?=$byC?>">Setor</a></th>
                    <th>Telefone</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td align="center">
                        <a href="main.php?action=edt&id=<?=$dados["id"]?>" id="btnEditar">
                            <span class="glyphicon glyphicon-edit"></span>
                        </a>
                    </td>
                    <td align="center">
                        <a href="main.php?action=del&id=<?=$dados["id"]?>" id="linkExcluir">
