	...
	if ($conta_result > 0){
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th><a href="index.php?opc=<?=$opc?>&buscar=<?=$buscar?>&id=<?=$id?>&action=buscar&order=@id&by=<?=$byC?>">Id</a></th>
                    <th><a href="index.php?opc=<?=$opc?>&buscar=<?=$buscar?>&id=<?=$id?>&action=buscar&order=@nome&by=<?=$byC?>">Nome</a></th>
					<th><a href="index.php?opc=<?=$opc?>&buscar=<?=$buscar?>&id=<?=$id?>&action=buscar&order=@nome&by=<?=$byC?>">Setor</a></th>
                    <th>Telefone</th>
                    <th>Celular</th>
